            ...
            <div class="table-responsive">
              <table class="table datatable table-light" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                      ...
                      <tr>
                        <td>1</td>
                        <td><button class="btn btn-success btn-sm">Send Money</button></td>
                        <td>April 4 2024</td>
                        <td><button class="btn btn-success btn-sm">In Progress</button></td>
                       
                        <td>
                          <button type="button" id="edit_cat_btn" data-id="" class="btn btn-primary bi bi-search">View</button>
                          <button type="button" class="btn btn-warning bi bi-pencil"> Modify</button>
                        </td>
                      </tr>
